...
public extension UIView
{
    ...
    // layer的简单配置
    func setupLayer(_ borderColor: UIColor, _ borderWidth: CGFloat, _ cornerRadius: CGFloat = 0, _ masksToBounds: Bool = true) -> Void {
...
public  extension UIView {
     ...
     */
    func addLineWithSide(_ side:LineViewSide, color:UIColor, thickness:CGFloat, margin1:CGFloat, margin2:CGFloat) -> Void {

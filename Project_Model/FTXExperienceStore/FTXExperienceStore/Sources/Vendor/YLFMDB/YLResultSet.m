...
@interface YLResultSet () {
    NSMutableDictionary *_columnNameToIndexMap;
}
@end

@implementation YLResultSet

+ (instancetype)resultSetWithStatement:(YLStatement *)statement usingParentDatabase:(YLDatabase*)aDB {
    
    YLResultSet *rs = [[YLResultSet alloc] init];

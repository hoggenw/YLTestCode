...
@property (nonatomic, strong, readwrite) NSString *videoUrlString;
...
- (void)setUpWriter
{
    self.videoUrlString = [self createVideoFilePath];
    self.videoUrl = [[NSURL alloc] initFileURLWithPath: self.videoUrlString];
...
//    NSLog(@"self.videoUrl.absoluteString: %@",self.videoUrl.absoluteString);
//    [self calculationFileSize: self.videoUrl.absoluteString];
    //var/mobile/Containers/Data/Application/6A305B35-D601-4F70-A506-5DF16C674851/Documents/EEMFLKFOPGLVFCMCJGAQWTZXXZBDXJZM.mp4

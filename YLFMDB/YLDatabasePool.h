...
@interface YLDatabasePool : NSObject
...
- (BOOL)databasePool:(YLDatabasePool*)pool shouldAddDatabaseToPool:(YLDatabase*)database;
...
- (void)databasePool:(YLDatabasePool*)pool didAddDatabase:(YLDatabase*)database;
